...
function wpeHeadNav() {
  ...
  array(
    ...
    'link_before'     => '',
    'link_after'      => '',
    'items_wrap'      => '<ul id="menu-glavnoe-menyu" class="top_menu">%3$s</ul>',
    'depth'           => 0,
    'walker'          => ''
    )
  );
...
function wpeFootNav() {
  ...
  array(
    ...
    'link_before'     => '',
    'link_after'      => '',
    'items_wrap'      => '<ul id="menu-vidy-fobij-po-predmetu-straha" class="fears_list_mobile">%3$s</ul>',
    'depth'           => 0,
    'walker'          => ''
    )
  );
...
function wpeSideNav() {
  ...
  array(
    ...
    'link_before'     => '',
    'link_after'      => '',
    'items_wrap'      => '<ul id="menu-vidy-depressij-1" class="menu">%3$s</ul>',
    'depth'           => 0,
    'walker'          => ''
    )
  );
...
function register_html5_menu() {
  register_nav_menus(array(
    ...
    'footer-menu' => __('Меню мобильное', 'wpeasy')
  ));
}
